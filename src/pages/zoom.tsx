      ...
      <div className="container w-full md:max-w-3xl mx-auto pt-20">
        <div className="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
          ...
          <p className="py-6">
            ...
            Etiam efficitur dolor in dolor molestie ornare. Aenean pulvinar diam nec neque tincidunt, vitae molestie
            quam fermentum. Donec ac pretium diam. Suspendisse sed odio risus. Nunc nec luctus nisi. Class aptent taciti
          ...
          <ol>
            <li className="py-3">
              Maecenas accumsan lacus sit amet elementum porta. Aliquam eu libero lectus. Fusce vehicula dictum mi. In
              non dolor at sem ullamcorper venenatis ut sed dui. Ut ut est quam. Suspendisse quam quam, commodo sit amet
          ...
          <pre className="bg-gray-900 rounded text-white font-mono text-base p-2 md:p-4">
            <code className="break-words whitespace-pre-wrap">
              &lt;header className="site-header outer"&gt; &lt;div className="inner"&gt;
            </code>
          </pre>
        </div>
        ...
        <div className="flex w-full items-center font-sans px-4 py-12">
          ...
          <div className="flex-1 px-2">
            ...
            <p className="text-gray-600 text-xs md:text-base">
              ...
              <a className="text-green-500 no-underline hover:underline" href="https://www.tailwindtoolbox.com">
                TailwindToolbox.com
              </a>
            </p>
          </div>
            ...
            <div className="flex w-full md:w-1/2 ">
              <div className="px-8">
                ...
                <p className="py-4 text-gray-600 text-sm">
                  ...
                  id erat. Suspendisse consectetur dapibus velit ut lacinia.
                </p>
              </div>
            </div>
